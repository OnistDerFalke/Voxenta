...
struct pin_value {
    ...
    static pin_value make_image(cv::Mat m) { pin_value v; v.type = pin_type::image;       v.image = std::move(m); return v; }
    static pin_value make_float(float val) { pin_value v; v.type = pin_type::float_value; v.f = val; return v; }
    static pin_value make_int(int val) { pin_value v; v.type = pin_type::int_value;   v.i = val; return v; }
    static pin_value make_bool(bool val) { pin_value v; v.type = pin_type::bool_value;   v.b = val; return v; }
};
